...
function devolverUltimoElemento(array) {
  ...
  // Tu código:
  let positionU= array.length -1;
  return array[positionU]
}
...
function incrementarPorUno(array) {
  ...
  // y devuelve el array
  // Tu código:
  return  array.map(incremento=> incremento +1)
}
...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
let contar = resultadosTest.map(e=>e)
let Amas =contar.join('+')
return eval(Amas)/resultadosTest.length
}
...
function cuentoElementos(arreglo){
  ...
  var found = arreglo.filter(element => element > 18);
...
function mesesDelAño(array) {
  ...
  var filtro = []
if(array.length > 5){
 f = array.find(mes=>mes === "Marzo")
 filtro.push(f)
 l = array.find(mes=>mes ===  "Noviembre")
 filtro.push(l)
 i= array.find(mes=>mes ==="Enero")
 filtro.push(i)
return filtro
}else{
